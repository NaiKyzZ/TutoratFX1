...
/** Premier gestionnaire d'événements. Variante 3
 * @author Brutus Philippe et Jeanpierre Laurent
 */
public class Prog4_2_1 extends Application {
	...
	public void start(Stage stage) {
		...
		stage.sizeToScene();
		stage.setTitle("Une fenêtre avec gestion d'événements");
		stage.setResizable(false);
		stage.show();
	}

} // public class Prog4_2_1
